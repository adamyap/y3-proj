...
try:
    while True:
        ...
        A_pos, B_pos = calculate_rotor_angles(ball_coordx1, ball_coordy1, ball_coordx2, ball_coordy2, velocity)
        
        # Send calculated positions to Arduino
        send_position('A', A_pos)
        send_position('B', B_pos)
